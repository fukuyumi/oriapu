  ...
  before do
    ...
    describe 'ユーザー新規登録' do
      context '新規登録できる場合' do
        it'nick_name,email,password,password_confiramation,family_name,first_name,family_name_kana,first_name_kanaが存在すれば登録できる' do
      ...
      context '新規登録ができない時' do
        ...
        it 'family_nameは全角（ひらがな・カタカナ・漢字）でないと登録できない' do
